<?php require '../controllers/dashboard.php';?>

<!-- TITLE -->
<?php $title = "TAHITI - AWAIE -- Dashboard";?>
<!-- CONTENT -->
<?php ob_start();?>
<div class="row">
    <div class="col-lg-9 main-chart">
        ...
        <?php
            echo "<h3 style='margin-left:15px;'>" . $data[0]['Nom'] . "</h3>";
            $GPS = null;
            //loop display graph of all company's sensors
            for ($i = 0; $i < count($data[0]['produit']); $i++) {
                $produit = $data[0]['produit'][$i];
